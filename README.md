...
- Issues reported must only cover actual functionality or user interface bugs/errors. Views on repair times, suggestions on improvements or other types of suggestions can be handled via existing channels/persons in the CABAS Estonia project.
